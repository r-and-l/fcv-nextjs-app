...
import { TelegramApp } from '@/components/layout/TelegramApp';
...
function Dashboard() {
  ...
  }, [isReady, startParam, teams, isLoading, initData, router, searchParams, chat, registerUser, joinTeam]);
  ...
  console.log(isReady, startParam, initData, chat );
